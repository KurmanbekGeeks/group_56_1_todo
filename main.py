...
def main(page: ft.Page):
    ...
    def create_task_row(task_id, task_text, completed):
        ...
        edit_button = ft.IconButton(icon=ft.Icons.EDIT, on_click=enable_edit, icon_color=ft.Colors.GREEN)
        save_button = ft.IconButton(icon=ft.Icons.SAVE, on_click=save_task, icon_color=ft.Colors.YELLOW_500)
        delete_button = ft.IconButton(icon=ft.Icons.DELETE, on_click=lambda e: delete_task(task_id),
